"""
Django settings for mute_hall_48172 project.
...
ROOT_URLCONF = 'mute_hall_48172.urls'
...
WSGI_APPLICATION = 'mute_hall_48172.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mute_hall_48172 API",
    "DESCRIPTION": "API documentation for mute_hall_48172 App",
    "VERSION": "v1",
}
